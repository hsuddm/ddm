...
public class CategoryWomanActivity extends Activity {

	LinearLayout linearlayout_woman;
	LinearLayout ll_category_bg;
	LinearLayout ll_category_left;
	LinearLayout ll_category_right;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.category_woman);
		...
		onepiece = (ImageView) findViewById(R.id.onepiece);
		...
		Typeface tf = Typeface.createFromAsset(CategoryWomanActivity.this
	...
	protected void onStart() {
		...
		onepiece.setImageResource(R.drawable.onepiece);
		skirt.setImageResource(R.drawable.skirt);
	...
	protected void onStop() {
		...
		onepiece.setImageDrawable(null);
		skirt.setImageDrawable(null);
	...
	public void onWindowFocusChanged(boolean hasFocus) {
		linearlayout_woman = (LinearLayout) findViewById(R.id.linearlayout_woman);

		double weight = linearlayout_woman.getWidth();
		...
		iv_top.setPadding((int) (weight * 0.111), (int) (height * 0.027),
				(int) (weight * 0.037), (int) (height * 0.027));
		iv_pants.setPadding((int) (weight * 0.111), (int) (height * 0.027),
				(int) (weight * 0.037), (int) (height * 0.053));
		onepiece.setPadding((int) (weight * 0.037), (int) (height * 0.053),
				(int) (weight * 0.111), (int) (height * 0.027));
		skirt.setPadding((int) (weight * 0.037), (int) (height * 0.027),
				(int) (weight * 0.111), (int) (height * 0.027));
